...
- Prebuilt chainload image(s) are provided by autobuild. Example filename:
  `autobuild_release/filogic/bootloader-mt7987/mt7987_bananapi_bpi-r4-lite-snand-nmbm-chainload-<timestamp>.img`
...
1. **Use the prebuilt chainload image generated by autobuild**
   - Example: `autobuild_release/filogic/bootloader-mt7987/mt7987_bananapi_bpi-r4-lite-snand-nmbm-chainload-<timestamp>.img`
2. **Load the chainload image into DRAM via TFTP**
   ```
   setenv serverip <your_tftp_server_ip>
   tftpboot 0x44000000 mt7987_bananapi_bpi-r4-lite-snand-nmbm-chainload-<timestamp>.img
   ```
...
```
setenv bootconf mt7987a-bananapi-bpi-r4-lite-nand-nmbm
saveenv
```
...
#### MT7987 Board-Specific Overlays for BananaPi BPI-R4 Lite (25.12 SDK)

Select the overlay according to your desired boot medium:

- **Boot from NAND Flash (NMBM):** `mt7987a-bananapi-bpi-r4-lite-nand-nmbm`
- **Boot from NAND Flash (Full-UBI):** `mt7987a-bananapi-bpi-r4-lite-nand`
- **Boot from NOR Flash:** `mt7987a-bananapi-bpi-r4-lite-nor`
- **Boot from eMMC:** `mt7987a-bananapi-bpi-r4-lite-emmc`
- **Boot from SD Card:** `mt7987a-bananapi-bpi-r4-lite-sd`
...
```bash
setenv bootconf mt7987a-bananapi-bpi-r4-lite-nand
...
1. **Use the prebuilt chainload image generated by autobuild**
   - Example: `autobuild_release/filogic/bootloader-mt7987/mt7987_bananapi_bpi-r4-lite-snand-chainload-<timestamp>.img`
2. **Load the chainload image into DRAM via TFTP**
   ```
   setenv serverip <your_tftp_server_ip>
   tftpboot 0x44000000 mt7987_bananapi_bpi-r4-lite-snand-chainload-<timestamp>.img
   ```
3. **Chainload the MediaTek official U-Boot**
   ```
   setenv autostart 1
...
|:---      |:---        |:---       |:---                                                                                              |
| v2.2     | 2026/03/11 | Sam Shih  | Use prebuilt chainload image and document GPT images; switch to board-specific overlay names; fix BL2 patterns |
