...
/* TOP Mailbox */
#define NPU_TOP_CM_SLOT			(MBOX_TOP_BASE + 0x000)
#define NPU_TOP_AP_SLOT			(MBOX_TOP_BASE + 0x004)

#define NPU_TOP_AP_TO_CM_CMD_SET		(MBOX_TOP_BASE + 0x200)
#define NPU_TOP_AP_TO_CM_CMD_CLR		(MBOX_TOP_BASE + 0x204)
#define NPU_TOP_CM_TO_AP_CMD_SET		(MBOX_TOP_BASE + 0x21C)
#define NPU_TOP_CM_TO_AP_CMD_CLR		(MBOX_TOP_BASE + 0x220)

#define NPU_TOP_AP_TO_CM_MSG_N(n)		(MBOX_TOP_BASE + 0x208 + 0x4 * (n))
#define NPU_TOP_CM_TO_AP_MSG_N(n)		(MBOX_TOP_BASE + 0x224 + 0x4 * (n))

/* CLUST Mailbox */
#define NPU_CLUST0_CX_SLOT(x)			(MBOX_CLUST0_BASE + (0x4 * (x)))
#define NPU_CLUST0_CM_SLOT			(MBOX_CLUST0_BASE + 0x10)
#define NPU_CLUST0_AP_SLOT			(MBOX_CLUST0_BASE + 0x14)

#define NPU_CLUST0_CX_TO_CY_CMD_SET(x, y)	\
		(MBOX_CLUST0_BASE + 0x100 + ((x) * 0x200) + ((y) * 0x40))
#define NPU_CLUST0_CX_TO_CY_CMD_CLR(x, y)	\
		(MBOX_CLUST0_BASE + 0x104 + ((x) * 0x200) + ((y) * 0x40))
#define NPU_CLUST0_CX_TO_CM_CMD_SET(x)		\
		(MBOX_CLUST0_BASE + 0x200 + ((x) * 0x200))
#define NPU_CLUST0_CX_TO_CM_CMD_CLR(x)		\
		(MBOX_CLUST0_BASE + 0x204 + ((x) * 0x200))
#define NPU_CLUST0_CX_TO_AP_CMD_SET(x)		\
		(MBOX_CLUST0_BASE + 0x240 + ((x) * 0x200))
#define NPU_CLUST0_CX_TO_AP_CMD_CLR(x)		\
		(MBOX_CLUST0_BASE + 0x244 + ((x) * 0x200))
#define NPU_CLUST0_CM_TO_CX_CMD_SET(x)		\
		(MBOX_CLUST0_BASE + 0x900 + ((x) * 0x40))
#define NPU_CLUST0_CM_TO_CX_CMD_CLR(x)		\
		(MBOX_CLUST0_BASE + 0x904 + ((x) * 0x40))
#define NPU_CLUST0_AP_TO_CX_CMD_SET(x)		\
		(MBOX_CLUST0_BASE + 0xB00 + ((x) * 0x40))
#define NPU_CLUST0_AP_TO_CX_CMD_CLR(x)		\
		(MBOX_CLUST0_BASE + 0xB04 + ((x) * 0x40))

#define NPU_CLUST0_CX_TO_CY_MSG_N(x, y, n)	\
		(MBOX_CLUST0_BASE + 0x108 + ((n) * 0x4) + ((x) * 0x200) + ((y) * 0x40))
#define NPU_CLUST0_CX_TO_CM_MSG_N(x, n)	\
		(MBOX_CLUST0_BASE + 0x208 + ((n) * 0x4) + ((x) * 0x200))
#define NPU_CLUST0_CX_TO_AP_MSG_N(x, n)	\
		(MBOX_CLUST0_BASE + 0x248 + ((n) * 0x4) + ((x) * 0x200))
#define NPU_CLUST0_CM_TO_CX_MSG_N(x, n)	\
		(MBOX_CLUST0_BASE + 0x908 + ((n) * 0x4) + ((x) * 0x40))
#define NPU_CLUST0_AP_TO_CX_MSG_N(x, n)	\
