...
#define TOP_L2SRAM_COM				(0x100000)
...
#define CLUST_L2SRAM_PKT			(0x600000)
#define CLUST_L2SRAM_COM			(0x700000)
#define CLUST_CORE_X_DTCM(x)			(0x800000 + 0x20000 * (x))
#define CLUST_CORE_X_ITCM(x)			(0x810000 + 0x20000 * (x))
#define LOWLAT_BASE				(0x880000)
#define DUMMY_REG_BASE				(LOWLAT_BASE + 0x0300)

#define CORE_BASE_LEN				(0x80)
#define L2SRAM_COM_LEN				(0x40000)
#define L2SRAM_PKT_LEN				(0x100000)
#define CORE_M_XTCM_LEN				(0x8000)
#define CORE_X_XTCM_LEN				(0x8000)
...
struct mcu_state_notifier {
	struct list_head node;
	int (*pre_enter)(struct mcu_state_notifier *nofitifier);
	int (*post_enter)(struct mcu_state_notifier *nofitifier);
	int (*pre_leave)(struct mcu_state_notifier *nofitifier);
	int (*post_leave)(struct mcu_state_notifier *nofitifier);
};
