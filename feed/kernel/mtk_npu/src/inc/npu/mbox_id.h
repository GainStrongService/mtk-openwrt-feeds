...
#ifndef _NPU_MBOX_ID_H_
#define _NPU_MBOX_ID_H_

enum mbox_cm2ap_cmd_id {
	MBOX_CM2AP_CMD_CORE_CTRL = 0,
	MBOX_CM2AP_CMD_LOGGER = 30,
...
enum mbox_ap2cm_cmd_id {
	...
	MBOX_AP2CM_CMD_MISC = 4,
	MBOX_AP2CM_CMD_LOGGER = 30,
