...
#ifndef _NPU_HPDMA_H_
#define _NPU_HPDMA_H_

#include <linux/bitops.h>
#include <linux/bitfield.h>

/* AXI DMA */
#define NPU_HPDMA_X_SRC(x)			(0x100 * (x) + 0x0000)
#define NPU_HPDMA_X_DST(x)			(0x100 * (x) + 0x0004)
#define NPU_HPDMA_X_NUM(x)			(0x100 * (x) + 0x0008)
#define NPU_HPDMA_X_CTRL(x)			(0x100 * (x) + 0x000C)
#define NPU_HPDMA_X_CLRIRQ(x)			(0x100 * (x) + 0x0010)
#define NPU_HPDMA_X_START(x)			(0x100 * (x) + 0x0014)
#define NPU_HPDMA_X_RRESP(x)			(0x100 * (x) + 0x0018)
#define NPU_HPDMA_X_BRESP(x)			(0x100 * (x) + 0x001C)
#define NPU_HPDMA_X_HW(x)			(0x100 * (x) + 0x0020)
#define NPU_HPDMA_X_ERR(x)			(0x100 * (x) + 0x0024)
...
int mtk_npu_hpdma_init(void);
void mtk_npu_hpdma_exit(void);
#endif /* _NPU_HPDMA_H_ */
