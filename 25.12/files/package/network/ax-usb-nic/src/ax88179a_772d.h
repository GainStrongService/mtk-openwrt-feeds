...
#define AX88179A_BUF_RX_SIZE			(48 * KB_SIZE)
#define AX88772_BUF_RX_SIZE				(24 * KB_SIZE)
#define AX88279_BUF_RX_SIZE				(48 * KB_SIZE)
...
#define AX88179A_WAKEUP_SETTING			0x07
	#define EPHY_LOW_POWER_EN 			0x0001
	#define S5_WOL_EN 					0x0004
	#define S5_WOL_LOW_POWER			0x0020
...
#define AX88179A_FLASH_ERASE_ALL		0x25
...
extern const struct driver_info ax88279a_info;
...
int ax88179a_get_sset_count(struct net_device *dev, int sset);
void ax88179a_get_ethtool_stats(struct net_device *dev, 
				struct ethtool_stats *stats, u64 *data);
void ax88179a_get_strings(struct net_device *netdev, u32 stringset, u8 *data);
int ax88279a_get_sset_count(struct net_device *dev, int sset);
void ax88279a_get_ethtool_stats(struct net_device *dev, 
				struct ethtool_stats *stats, u64 *data);
