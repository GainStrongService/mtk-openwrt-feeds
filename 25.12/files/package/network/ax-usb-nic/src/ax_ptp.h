...
#define PTP_LCK_80B_TIMER_NS_EN         	(1 << 1)
#define PTP_LCK_80B_TIMER_S_EN          	(1 << 2)
#define PTP_LCK_48B_TIMER_EN            	(1 << 3)
#define PTP_LCK_DIS_CDC                 	(1 << 4)
#define PTP_LCK_PPS_EN                  	(1 << 5)
#define PTP_LCK_PTP_RX_MAC_SEL          	(1 << 12)
#define PTP_LCK_PTP_TX_MAC_SEL          	(1 << 13)
#define PTP_LCK_PTP_TX_MAC_SFD_SEL       	(1 << 14)
#define PTP_DMA_CTRL            			0x0000
#define PTP_LCK_CTRL            			0x1000
#define PTP_LCK_TIMER_ADDEND    			0x102C
#define PTP_LCK_TIMER_PERIOD    			0x1030
#define PTP_LCK_TX_DELAY        			0x1034
#define PTP_LCK_RX_DELAY        			0x1038
#define PTP_RX_CTRL_0           			0x2000
#define PTP_RX_EN                       	(1 << 0)
#define PTP_RX_PARSER_L2_PTP_EN         	(1 << 8)
#define PTP_RX_PARSER_IPV4_EN           	(1 << 9)
#define PTP_RX_PARSER_IPV6_EN           	(1 << 10)
#define PTP_RX_PARSER_VLAN_EN           	(1 << 11)
#define PTP_RX_PARSER_PPPOE_EN          	(1 << 12)
#define PTP_RX_PARSER_SNAP_EN           	(1 << 13)
#define PTP_RX_PARSER_UDP_EN            	(1 << 14)
#define PTP_RX_PARSER_UDPV6_EN          	(1 << 15)
#define PTP_RX_PARSER_GEN_EN            	(1 << 16)
#define PTP_RX_PARSER_EVENT_EN          	(1 << 17)
#define PTP_RX_CTRL_0_DEFAULT           	(PTP_RX_EN 				| \
                                         	PTP_RX_PARSER_L2_PTP_EN | \
                                         	PTP_RX_PARSER_IPV4_EN 	| \
                                         	PTP_RX_PARSER_IPV6_EN 	| \
                                         	PTP_RX_PARSER_VLAN_EN 	| \
                                         	PTP_RX_PARSER_PPPOE_EN 	| \
                                        	PTP_RX_PARSER_SNAP_EN 	| \
                                         	PTP_RX_PARSER_UDP_EN 	| \
                                         	PTP_RX_PARSER_UDPV6_EN 	| \
                                         	PTP_RX_PARSER_GEN_EN 	| \
                                         	PTP_RX_PARSER_EVENT_EN)
#define PTP_TX_EN                       	(1 << 0)
#define PTP_TX_MAC_SEL 				    	(1 << 4)
#define PTP_TX_PARSER_L2_PTP_EN         	(1 << 8)
#define PTP_TX_PARSER_IPV4_EN           	(1 << 9)
#define PTP_TX_PARSER_IPV6_EN           	(1 << 10)
#define PTP_TX_PARSER_VLAN_EN           	(1 << 11)
#define PTP_TX_PARSER_PPPOE_EN          	(1 << 12)
#define PTP_TX_PARSER_SNAP_EN           	(1 << 13)
#define PTP_TX_PARSER_UDP_EN            	(1 << 14)
#define PTP_TX_PARSER_UDPV6_EN          	(1 << 15)
#define PTP_TX_PARSER_GEN_EN            	(1 << 16)
#define PTP_TX_PARSER_EVENT_EN          	(1 << 17)
#define PTP_TX_CTRL_0_DEFAULT           	(PTP_TX_EN 				| \
                                        	PTP_TX_PARSER_L2_PTP_EN | \
                                         	PTP_TX_PARSER_IPV4_EN 	| \
                                         	PTP_TX_PARSER_IPV6_EN 	| \
                                         	PTP_TX_PARSER_VLAN_EN 	| \
                                        	PTP_TX_PARSER_PPPOE_EN 	| \
                                         	PTP_TX_PARSER_SNAP_EN 	| \
                                         	PTP_TX_PARSER_UDP_EN 	| \
                                         	PTP_TX_PARSER_UDPV6_EN 	| \
                                         	PTP_TX_PARSER_GEN_EN 	| \
                                         	PTP_TX_PARSER_EVENT_EN)
#define PTP_TX_VAL_DELAY_CNT_SHIFT      	24
#define PTP_TX_CTRL_0           			0x3000
#define PTP_RX_SHIFT_FIFO_SEL           	(1 << 1)
#define PTP_TX_SHIFT_FIFO_SEL           	(1 << 1)
...
#define VENDOR_CMD_PTP_SW_MODE  			0xE3
#define SW_MODE_STOP           				0x0001
#define SW_MODE_RING_SETTINGS  				0x0002
#define SW_MODE_HW_CONFIG      				0x0004
#define SW_MODE_START          				0x0008
#define SW_MODE_RING_HEAD      				0x0010
