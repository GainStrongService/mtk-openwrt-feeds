...
define Device/mediatek_mt7988a-dsa-10g-an8831x-spim-nand
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988a-dsa-10g-an8831x-spim-nand
  DEVICE_DTS := mt7988a-dsa-10g-an8831x-spim-nand
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988a-dsa-10g-an8831x-spim-snand
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988a-dsa-10g-an8831x-spim-nand

define Device/mediatek_mt7988a-dsa-mxl86252-10g-spim-nand
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988a-dsa-mxl86252-10g-spim-nand
  DEVICE_DTS := mt7988a-dsa-mxl86252-10g-spim-nand
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988a-dsa-mxl86252-10g-spim-snand
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988a-dsa-mxl86252-10g-spim-nand
...
define Device/mediatek_mt7988d-dsa-10g-an8831x-spim-nand
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988d-dsa-10g-an8831x-spim-nand
  DEVICE_DTS := mt7988d-dsa-10g-an8831x-spim-nand
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988d-dsa-10g-an8831x-spim-snand
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988d-dsa-10g-an8831x-spim-nand
...
define Device/mediatek_mt7988a-dsa-10g-spim-nand-wifi-emi
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988a-dsa-10g-spim-nand-wifi-emi
  DEVICE_DTS := mt7988a-dsa-10g-spim-nand-wifi-emi
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988a-dsa-10g-spim-snand-wifi-emi
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988a-dsa-10g-spim-nand-wifi-emi

define Device/mediatek_mt7988d-dsa-10g-spim-nand-wifi-emi
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988d-dsa-10g-spim-nand-wifi-emi
  DEVICE_DTS := mt7988d-dsa-10g-spim-nand-wifi-emi
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988d-dsa-10g-spim-snand-wifi-emi
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988d-dsa-10g-spim-nand-wifi-emi

define Device/mediatek_mt7988a-dsa-10g-spim-nand-4pcie
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988a-dsa-10g-spim-nand-4pcie
  DEVICE_DTS := mt7988a-dsa-10g-spim-nand-4pcie
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988a-dsa-10g-spim-snand-4pcie
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988a-dsa-10g-spim-nand-4pcie
