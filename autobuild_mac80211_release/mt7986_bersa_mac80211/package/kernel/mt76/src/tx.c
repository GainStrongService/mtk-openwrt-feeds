...
void mt76_tx_worker_run(struct mt76_dev *dev)
{
	...
	if (dev->phy3)
		mt76_txq_schedule_all(dev->phy3);
	...
	if (dev->phy3 && dev->phy3->test.tx_pending)
		mt76_testmode_tx_pending(dev->phy3);
#endif
}
...
{
	struct mt76_phy *phy = &dev->phy, *phy2 = dev->phy2, *phy3 = dev->phy3;
